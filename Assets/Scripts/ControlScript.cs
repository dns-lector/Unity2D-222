...
public class ControlScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // 2. Input Manager - робота з "осями"
        // float y = Input.GetAxis("Vertical");
        // rb.AddForce(y * 5 * Vector2.up);

        // 3. Input System - до версії Unity 6 необхідно встановлення як пакету
        Vector2 moveValue = moveAction.ReadValue<Vector2>();
        rb.AddForce(
            moveValue.y * 5 * Vector2.up + 
            moveValue.x * 5 * Vector2.right);
    }
}
/* Д.З. Реалізувати управління елементами сцени (з попереднього ДЗ)
 * за допомогою цифр: натиснення "1" дає поштовх першому елементу і т.д.
 * Підібрати величини сили для різних тіл різної маси.
 * Додати до звіту відеозапис роботи проєкту.
 */
